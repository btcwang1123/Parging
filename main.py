            ...
            folium.Marker(
                ...
                popup=folium.Popup(f"""
                    ...
                    <a href="https://www.google.com/maps/dir/?api=1&destination={park['LATITUDE']},{park['LONGITUDE']}" target="_blank" >
                        <img src="https://png.pngtree.com/png-clipart/20230917/original/pngtree-volkswagen-beetle-car-sticker-retro-clipart-vector-png-image_12270600.png" alt="導航" style="width:50px;height:50px;"><br>__導航
                    </a>
                    </div>
                """, max_width=220),
